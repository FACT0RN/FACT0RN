...
class ReorgsRestoreTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        txid_conflict_from = self.nodes[0].sendtoaddress(self.nodes[0].getnewaddress(), Decimal("0.03161907"))
        ...
        txid = self.nodes[0].sendtoaddress(self.nodes[0].getnewaddress(), Decimal("0.03161907"))
        ...
        nA = next(tx_out["vout"] for tx_out in self.nodes[0].gettransaction(txid_conflict_from)["details"] if tx_out["amount"] == Decimal("0.03161907"))
        inputs = []
        ...
        outputs_1[self.nodes[0].getnewaddress()] = Decimal("0.03161899")
        outputs_2[self.nodes[0].getnewaddress()] = Decimal("0.03161899")
