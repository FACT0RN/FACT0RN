...
const char * const BITCOIN_CONF_FILENAME = "factorn.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Factorn";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Factorn";
#else
    // Unix-like
    return pathRet / ".factorn";
#endif
#endif
}
